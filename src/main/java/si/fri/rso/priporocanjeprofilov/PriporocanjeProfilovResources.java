...
package si.fri.rso.priporocanjeprofilov;
...
@Path("priporocanjeProfilov")
@RequestScoped
public class PriporocanjeProfilovResources {

    private Logger log = LogManager.getLogger(PriporocanjeProfilovResources.class.getName());
